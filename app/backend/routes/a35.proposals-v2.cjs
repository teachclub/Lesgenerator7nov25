    ...
    proposals: [
      {
        ...
        concept: {
          ...
          hook: "Leerlingen kruipen in de huid van tijdgenoten die spanningen tussen machtsblokken als normaal onderdeel van de wereldpolitiek zagen.",
          hoofdvraag:
          ...
          deelvragen: [
            ...
            {
              vraag:
                "Hoe beinvloedden propaganda, media en normen het beeld van de vijand?",
          ...
          leeropbrengsten: [
            lo(
              "Leerlingen kunnen uitleggen waarom tijdgenoten spanningen tussen machtsblokken als normaal onderdeel van de wereldpolitiek konden ervaren.",
              0
            ),
            lo(
      ...
      },
      {
        ...
        concept: {
          ...
          deelvragen: [
            ...
            {
              vraag:
                "Hoe beinvloedden banen, lonen en economie de manier waarop mensen kozen en overleefden?",
              dimensie: "Economie & Middelen",
            ...
            },
            {
              ...
              dimensie: "Tijd & Tijdgeest",
              subdimensie: "heersende ideeen en verwachtingen",
            },
          ],
          leeropbrengsten: [
            lo(
      ...
      },
      {
        ...
        concept: {
          ...
          hoofdvraag:
            "Hoe konden mensen destijds hun eigen idealen en overtuigingen zo vanzelfsprekend vinden, zelfs als wij die nu vreemd of problematisch vinden?",
          deelvragen: [
            {
              vraag:
                "Welke idealen en doelen spraken leiders en bewegingen uit in deze periode?",
              dimensie: "Politiek & Macht",
              subdimensie: "ideologieen, partijprogramma's en leiderschap",
            },
            {
              vraag:
