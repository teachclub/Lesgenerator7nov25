...
function buildBasePreamble(CHAIN_SIGNATURE) {
  return [
    ...
    "   - Voor elke geselecteerde bron formuleer je minimaal 4 inhoudelijke vragen."
    ...
    "     * je gebruikt bij voorkeur het aantal bronnen dat beschikbaar is gesteld,",
    "     * per geselecteerde bron formuleer je 4 vragen,",
    "     * in totaal kom je zo grofweg uit op minimaal 32 bronvragen.",
